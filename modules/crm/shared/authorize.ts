...
import { PermissionDeniedError } from "@/modules/crm/errors";

// Mirrors modules/planning/shared/authorize.ts exactly — CRM keeps its own copy rather than a
// cross-module refactor, same decision made for Planning.

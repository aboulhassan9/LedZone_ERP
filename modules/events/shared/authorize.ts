...
import { PermissionDeniedError } from "@/modules/events/errors";

// Mirrors modules/crm/shared/authorize.ts exactly — Events keeps its own copy rather than a
// cross-module refactor, same decision made for Planning and CRM.

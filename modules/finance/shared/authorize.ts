...
import { PermissionDeniedError } from "@/modules/finance/errors";

// Mirrors modules/crm/shared/authorize.ts exactly — Finance keeps its own copy rather than a
// cross-module refactor, same decision made for Planning, CRM, Events, and Rental.

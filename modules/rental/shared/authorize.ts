...
import { PermissionDeniedError } from "@/modules/rental/errors";

// Mirrors modules/crm/shared/authorize.ts exactly — Rental keeps its own copy rather than a
// cross-module refactor, same decision made for Planning, CRM, and Events.

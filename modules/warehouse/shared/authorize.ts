...
import { PermissionDeniedError } from "@/modules/warehouse/errors";
...
// modules/inventory/shared/authorize.ts exactly.
...
// warehouse.manage OR warehouse.transfer).
...
// Read-only check (no throw) — used where a service needs to branch behavior (e.g. allow
// exceeding declared capacity) rather than reject the whole action.
